...
count[:,4]=[125  116  117  117  114  114  112  103  97  104  92  87  89  67  72  67  71  65  60  61  67  64  73  71  79  75  85  82  89  87  97  107  104  106  118  116  111  119];
count[:,5]=[127  125  122  120  122  119  119  112  109  107  110  102  97  99  94  94  93  101  93  94  86  101  94  91  98  99  97  96  103  107  106  104  119  114  124  122  124  120];
...
e+=(+log(u2(xlocdata[ii])^count[ii,2]*(1-u2(xlocdata[ii]))^(max(122-count[ii,2],0)))
    +log(u3(xlocdata[ii])^count[ii,3]*(1-u3(xlocdata[ii]))^(max(122-count[ii,3],0)))
    +log(u4(xlocdata[ii])^count[ii,4]*(1-u4(xlocdata[ii]))^(max(122-count[ii,4],0)))
    +log(u5(xlocdata[ii])^count[ii,5]*(1-u5(xlocdata[ii]))^(max(122-count[ii,5],0)))
   )   
end
    return e
end
...
spl=Spline1D(Drange,ff.-maximum(ff),w=ones(length(Drange)),k=3,bc="nearest",s=0.1)
...
spl=Spline1D(λrange,ff.-maximum(ff),w=ones(length(λrange)),k=3,bc="nearest",s=0.5)
...
spl=Spline1D(βrange,ff.-maximum(ff),w=ones(length(βrange)),k=3,bc="nearest",s=0.5)
